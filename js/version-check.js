...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/LibreSpark/BiliTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/LibreSpark/BiliTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/LibreSpark/BiliTV', '_blank');
                    });
                }
            }, 100);
        } else {
